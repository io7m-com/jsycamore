...
/**
 * A north-west resize button.
 */

public final class SyWindowResizeNW
  ...
  implements SyButtonReadableType
{
  ...
  SyWindowResizeNW(final SyScreenType screen)
  {
    super(screen, WINDOW_RESIZE_NW, List.of());
  }
  ...
  {
    return List.of(SyThemeClassNameStandard.WINDOW_RESIZE_NW, BUTTON);
  }
