...
/**
 * A south-west resize button.
 */

public final class SyWindowResizeSW extends SyWindowComponent
{
  ...
  {
    return List.of(SyThemeClassNameStandard.WINDOW_RESIZE_SW, BUTTON);
  }
}
