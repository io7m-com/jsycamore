...
/**
 * A south resize button.
 */

public final class SyWindowResizeS
  ...
  implements SyButtonReadableType
{
  ...
  SyWindowResizeS(final SyScreenType screen)
  {
    super(screen, WINDOW_RESIZE_S, List.of());
  }
  ...
  {
    return List.of(SyThemeClassNameStandard.WINDOW_RESIZE_S, BUTTON);
  }
