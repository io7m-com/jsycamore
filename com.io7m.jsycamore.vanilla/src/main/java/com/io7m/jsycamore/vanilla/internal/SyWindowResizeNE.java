...
/**
 * A north-east resize button.
 */

public final class SyWindowResizeNE
  ...
  implements SyButtonReadableType
{
  ...
  SyWindowResizeNE(final SyScreenType screen)
  {
    super(screen, WINDOW_RESIZE_NE, List.of());
  }
  ...
  {
    return List.of(SyThemeClassNameStandard.WINDOW_RESIZE_NE, BUTTON);
  }
