...
/**
 * A theme component for scrollbar tracks.
 */

public final class SyPrimalScrollbarHTrack extends SyPrimalAbstract
{
  /**
   * A theme component for scrollbar tracks.
   *
  ...
  public SyPrimalScrollbarHTrack(
