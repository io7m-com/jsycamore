  ...
  implements SyFontServiceType
{
  ...
  public SyFontServiceDejaVuSansBold()
  {
  ...
  public InputStream openStream()
    throws IOException
  {
    final var url = SyFontServiceDejaVuSansBold.class.getResource(
      "/com/io7m/jsycamore/font/dejavu/DejaVuSans-Bold.ttf");
    if (url == null) {
