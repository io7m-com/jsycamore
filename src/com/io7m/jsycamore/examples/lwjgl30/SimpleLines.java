...
public final class SimpleLines implements Runnable
{
    ...
    final String args[])
  {
    try {
      ...
      Display.setDisplayMode(new DisplayMode(
        SimpleLines.viewport_size.x,
        SimpleLines.viewport_size.y));
      Display.create();

      final SimpleLines sw = new SimpleLines();
      sw.run();
      ...
      GUIException
  {
    ...
    this.gui =
      new GUI(
        SimpleLines.viewport_position,
        SimpleLines.viewport_size,
        this.gl,
        this.fs,
        this.log);
  }
