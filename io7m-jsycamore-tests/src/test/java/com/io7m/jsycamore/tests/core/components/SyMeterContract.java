...
public abstract class SyMeterContract extends SyComponentContract
{
  ...
  @Test public final void testPressLeftAttachedHorizontal()
  {
  ...
  @Test public final void testHeldLeftAttachedHorizontal()
  {
    final SyGUIType gui = this.gui();
    final SyWindowType window = gui.windowCreate(320, 240, "Window 0");
  ...
  @Test public final void testPressLeftAttachedVertical()
  {
    final SyGUIType gui = this.gui();
    final SyWindowType window = gui.windowCreate(320, 240, "Window 0");
  ...
  @Test public final void testPressLeftHeldVertical()
  {
    final SyGUIType gui = this.gui();
    final SyWindowType window = gui.windowCreate(320, 240, "Window 0");
