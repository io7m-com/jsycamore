...
@Component(
  ...
  property = {"com.io7m.jsycamore.theme.name=Stride"})
public final class SyThemeStrideProvider implements SyThemeProviderType
{
  /**
   * Construct a theme provider.
   */

  public SyThemeStrideProvider()
  {
  ...
  {
    return SyThemeStride.builder().build();
  }
}
