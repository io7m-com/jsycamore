...
import static com.io7m.jsycamore.api.themes.SyThemeClassNameStandard.SCROLLBAR_VERTICAL_BUTTON_THUMB;
import static com.io7m.jsycamore.api.themes.SyThemeClassNameStandard.SCROLLBAR_VERTICAL_BUTTON_THUMB_ICON;
...
final class SyScrollBarVButtonThumb
  extends SyComponentAbstract
  implements SyButtonReadableType
{
  private static final Logger LOG =
    LoggerFactory.getLogger(SyScrollBarVButtonThumb.class);
  ...
  {
    return List.of(SCROLLBAR_VERTICAL_BUTTON_THUMB);
  }
    ...
    final SyMouseEventOnHeld e)
  {
    ...
    final var trackSize =
      this.track.size().get().sizeY();
    final var trackDelta =
      (double) mouseDelta.y() / (double) trackSize;
