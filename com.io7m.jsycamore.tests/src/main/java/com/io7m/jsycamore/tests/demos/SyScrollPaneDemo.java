  ...
  private static final class Canvas extends JPanel
  {
      ...
      throws Exception
    {
...

      {
        ...
        final var paneContent = new SyLayoutVertical(this.screen);
        for (int index = 0; index < 10; ++index) {
          paneContent.childAdd(button(this.screen, SyText.text("Button " + index)));
        }

        this.scrollPane = SyScrollPanes.create(this.screen);
