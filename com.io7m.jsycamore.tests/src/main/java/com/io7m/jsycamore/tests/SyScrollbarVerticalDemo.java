...
public final class SyScrollbarVerticalDemo
{
  private static final Logger LOG =
    LoggerFactory.getLogger(SyScrollbarVerticalDemo.class);

  private SyScrollbarVerticalDemo()
  {
      ...
      throws Exception
    {
      ...
      final var mouseAdapter = new MouseAdapter()
      {
        ...
        public void mousePressed(
          final MouseEvent e)
        {
          SyScrollbarVerticalDemo.Canvas.this.screen.mouseDown(
            PVector2I.of(e.getX(), e.getY()),
            SyMouseButton.ofIndex(e.getButton() - 1));
          SyScrollbarVerticalDemo.Canvas.this.repaint();
        }
        ...
        public void mouseDragged(
          final MouseEvent e)
        {
          SyScrollbarVerticalDemo.Canvas.this.screen.mouseMoved(PVector2I.of(
            e.getX(),
            e.getY()));
          SyScrollbarVerticalDemo.Canvas.this.repaint();
        }
        ...
        public void mouseReleased(
          final MouseEvent e)
        {
          SyScrollbarVerticalDemo.Canvas.this.screen.mouseUp(
            PVector2I.of(e.getX(), e.getY()),
            SyMouseButton.ofIndex(e.getButton() - 1));
          SyScrollbarVerticalDemo.Canvas.this.repaint();
        }
          ...
          final MouseEvent e)
        {
          final PVector2I<SySpaceViewportType> position =
            PVector2I.of(e.getX(), e.getY());
          SyScrollbarVerticalDemo.Canvas.this.screen.mouseMoved(position);
          SyScrollbarVerticalDemo.Canvas.this.repaint();
        }
      };
      ...
      this.addComponentListener(new ComponentAdapter()
      {
        ...
        {
          SyScrollbarVerticalDemo.Canvas.this.screen.setSize(
            PAreaSizeI.of(
...

      {
        ...
        final var scrollbar = SyScrollBarsVertical.create();
        scrollbar.setScrollPositionSnapping(1.0 / 64.0);
        scrollbar.setScrollAmountShown(0.5);
        scrollbar.setOnThumbDragListener(drag -> {
          LOG.debug("Drag: {}", drag);
        });
        scrollbar.setOnClickUpListener(() -> {
          LOG.debug("Click Up!");
        });
        scrollbar.setOnClickDownListener(() -> {
          LOG.debug("Click Down!");
        });
