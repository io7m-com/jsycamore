...
final class SyTDEmbossSelector extends JPanel implements SyTDControlsType
{
  ...
  SyTDEmbossSelector(final String in_title)
  {
    ...
    this.color_top = new SyTDColorSelector(new VectorI3F(0.8f, 0.8f, 0.8f));
    this.color_left = new SyTDColorSelector(new VectorI3F(0.8f, 0.8f, 0.8f));
    this.color_right = new SyTDColorSelector(new VectorI3F(0.2f, 0.2f, 0.2f));
    this.color_bottom = new SyTDColorSelector(new VectorI3F(0.2f, 0.2f, 0.2f));
