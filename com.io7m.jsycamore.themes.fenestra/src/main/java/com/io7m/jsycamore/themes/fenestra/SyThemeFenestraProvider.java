...
@Component(
  ...
  property = {"com.io7m.jsycamore.theme.name=Fenestra"})
public final class SyThemeFenestraProvider implements SyThemeProviderType
{
  /**
   * Construct a theme provider.
   */

  public SyThemeFenestraProvider()
  {
  ...
  {
    return SyThemeFenestra.builder().build();
  }
}
