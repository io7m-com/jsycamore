...
public final class SyMultiplyComposite extends SyAbstractComposite
{
  private static final SyMultiplyComposite INSTANCE =
    new SyMultiplyComposite();

  public static SyMultiplyComposite get()
  {
    return INSTANCE;
  }

  private SyMultiplyComposite()
  {
